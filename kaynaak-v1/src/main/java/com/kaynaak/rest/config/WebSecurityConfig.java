...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .antMatchers("/v1/register", "/v1/login", "/v1/activeUser").permitAll()
                .antMatchers("/v1/chef/**").hasAuthority(UserRoleConstant.ADMIN_ROLE)
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(
        	HttpMethod.POST,"/v1/register", "/v1/activeUser", "/v1/login","/v1/resetPasswordInit","/v1/resetPassword"
        );
        web.ignoring().antMatchers(
                HttpMethod.GET,
                "/",
